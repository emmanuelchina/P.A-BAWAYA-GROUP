...
// bg-gradient-to-br from-gray-100 via-gray-100 to-gray-100 

// absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(251,191,36,0.15),transparent_60%)]
  ...
  return (
    <section className="relative bg-gray-100 py-20 px-4 overflow-hidden">
      ...
      <div className="relative bg-gray-100 max-w-7xl mx-auto">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full bg-gray-500/10 text-indigo-600 px-4 py-1 text-sm font-medium">
            ✨ Our Expertise
          </span>
        ...
        >
          <button className="inline-flex items-center gap-2 rounded-full bg-slate-500 px-8 py-3 font-semibold text-white hover:bg-gray-400 transition">
            View All Services →
          </button>
        </motion.div>
      </div>
