        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50/50 p-10 md:p-14 flex flex-col justify-between relative">
          ...
          <div className="mt-8 space-y-6 relative z-10">
            ...
            <a 
              ...
              className="group flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 border border-green-200/50 hover:border-green-300 hover:shadow-md transition-all duration-300 block"
            >
              <div className="flex-shrink-0 p-2 bg-green-100/80 rounded-xl shadow-sm group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                <WhatsAppIcon className="h-6 w-6 text-green-600" />
              </div>
              <div>
                <p className="font-semibold text-gray-900 text-lg group-hover:text-green-700 transition-colors">+234 803 337 4082</p>
                <p className="text-sm text-gray-600 group-hover:text-green-600 transition-colors">Message on WhatsApp</p>
              </div>
            </a>
